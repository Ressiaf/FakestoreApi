const LoadingButton = ({color="blackL"}) => {

    const Buttonclass = "relative group items-center px-8 py-2  cursor-pointer text-white font-medium rounded text-sm text-center  inline-flex items-center ";
    let Buttoncolor;
        if (color === "black") {
